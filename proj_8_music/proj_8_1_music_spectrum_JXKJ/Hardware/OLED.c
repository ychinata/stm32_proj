...
#define OLED_SCL_SET	GPIO_SetBits(GPIOA,GPIO_Pin_10)
#define OLED_SCL_RESET	GPIO_ResetBits(GPIOA,GPIO_Pin_10)
#define OLED_SDA_SET	GPIO_SetBits(GPIOA,GPIO_Pin_9)
#define OLED_SDA_RESET	GPIO_ResetBits(GPIOA,GPIO_Pin_9)
