...
{  
    ...
    Gyro_bias=0-Gyro; 
    //计算平衡控制的电机PWM PD控制
    balance = -Balance_Kp/100*Angle_bias - Gyro_bias*Balance_Kd/100;    //kp是P系数极性为负,kd是D系数极性为负
    return balance;
}
...
//    turn = Turn_Target*Kp/100 + gyro*100/100;            //调试时直接修改kp,kd值，不修改全局变量
