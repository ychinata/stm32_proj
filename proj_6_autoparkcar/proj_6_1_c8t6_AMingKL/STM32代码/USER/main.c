/*
 * @Author: _oufen
 * @Date: 2023-04-18 14:10:35
 * @LastEditTime: 2023-04-18 14:24:18
 * @Description: 
 */
/**
 *************************************************************************************************************************
...
int main(void)
{
    ...
    {
    case BACK_PACKING:
        Usart3_SendString("startcnt1");
        break; // 根据模式选择开启倒车入库识别函数
    case SIDE_PACKING:
        Usart3_SendString("startcnt2");
        break; // 根据模式选择开启侧方停车识别函数
    case BACK_SIDE_PACKING:
        Usart3_SendString("startcnt1");
        break; // 根据模式先选择开启倒车入库识别函数,后续改变
    default:
        break;
    }
    while (1)
